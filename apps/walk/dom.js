...
function addcss() {
	...
	/*background*/
	//addStyleString(".introjs-overlay{background-color:#e06400}");
	addStyleString(".introjs-overlay{background-color:#fff}");
	/*button*/
	//var style_button = ".introjs-button{border:1px solid #ccc;color:#7a7a7a;background-color:#fff;-webkit-background-clip:padding;-moz-background-clip:padding;-o-background-clip:padding-box;-webkit-border-radius:.2em;-moz-border-radius:.2em;font-size:14px}"
	var style_button = ".introjs-button{border:1px solid #ccc;color:#00C6D7;background-color:#fff;-webkit-background-clip:padding;-moz-background-clip:padding;-o-background-clip:padding-box;-webkit-border-radius:.2em;-moz-border-radius:.2em;font-size:14px}"
	...
	addStyleString(".uengager_editor{z-index:99999999;position:fixed;width:100%;height:50px;background-color:#fff;border-bottom:2px solid #f0ad4e;top:0}.uengager_editor_left{z-index:99999999;position:fixed;width:30px;padding-left:5px;padding-right:5px;text-align:center;height:60px;overflow:hidden;left:0;background-color:#e06400;border-bottom-right-radius:5px;cursor:pointer;top:0}.uengager_editor_right{position:absolute;width:15px;height:50px;right:0;background-color:#f0ad4e;border-bottom-left-radius:5px;cursor:pointer}.uengager_editor_content{width:460px;height:48px;margin:auto}.uengager_editor_button{float:left;background-color:#f0ad4e;color:#fff;width:60px;height:30px;margin-top:10px;text-align:center;line-height:30px;border-radius:5px;cursor:pointer;margin-left:10px}.uengager_editor_button:hover{background-color:#e06400}.uengager_editor_button_gray{float:left;background-color:#bfbfbf;color:#fff;width:60px;height:30px;margin-top:10px;text-align:center;line-height:30px;border-radius:5px;cursor:pointer;margin-left:10px}.uengager_editor_button_gray:hover{background-color:#cfbfbf}.uengager_editor_button_blue{float:left;background-color:#3498db;color:#fff;width:60px;height:30px;margin-top:10px;text-align:center;line-height:30px;border-radius:5px;cursor:pointer;margin-left:10px}.uengager_editor_button_blue:hover{background-color:#6498db}.uengager_editor_select{float:left;width:200px;height:30px;cursor:pointer;margin-top:10px;margin-left:10px;border-radius:2px;border-bottom:1px solid #f0ad4e}.uengager_editor_close{width:30px;height:14px;margin-top:17px;float:left;border-radius:7px;border:1px solid #f0ad4e;cursor:pointer;padding:0}.uengager_editor_close_select{width:14px;height:14px;background-color:#3498db;float:left;border-radius:7px;padding:0}.hidden{display:none!important}.uengager_editor_add_all{width:100%;position:fixed;z-index:9999999;top:0}.uengager_editor_add_window{background-color:#fff;line-height:24px;font-size:14px;width:300px;margin-left:auto;margin-right:auto;margin-top:60px;border:1px solid #f0ad4e;border-radius:10px}");
};
var stepnumber = 0;
...
var show_background_o = false;
/***/
function uengager_editor_init(){
	var UELWM = false;
	$("#uengager_editor").remove();
	//var html = "<div style='position:fixed;width:100%;height:100%;background-color:#000000;z-index:999999999;top:50px;opacity:0.7;'></div>";
	var html = "<div id='uengager_editor' class='uengager_editor'>"
		+"<div class='uengager_editor_content'>"	
		+"<div style='width:80px' class='uengager_editor_button' id='add_step'>添加步骤</div>"
		+"<div style='width:80px' class='uengager_editor_button_blue uengager_editor_prevewall'>查看结果</div>";
	if(show_background){
		html += "<div style='width:80px' class='uengager_editor_button_blue uengager_editor_background'>背景显示</div>";
	}else{
		html += "<div style='width:80px' class='uengager_editor_button_gray uengager_editor_background'>背景隐藏</div>";
	}
	html +=	"<div style='float:left;margin-left:10px;margin-top:10px;line-height:30px;color:#f0ad4e;'>当前已添加&nbsp;"+usteps.length+"&nbsp;个引导框</div>"
		+"</div>"
		+"</div>";
...
function uengager_editor_left(go){
  ...
  var editor = introJs();
	try{
		...
		editor.setOptions({
			...
			showBullets: false,
			showButton: false,
			overlayOpacity: show_background_o,
			doneLabel: '保存',
			onClick: myExampleClickHandler,
			steps: [{
...
$(document).on("click","#add_step", function(){
	...
	$(".uengager_editor_add_window").css("height","216px");
...
$(document).on("click", '.uengager_editor_prevewall', function(){
	if(usteps.length <= 0){
		alert("请先添加步骤");
		return;
	}
	uengager_editor_left(false);
	startEditorprevew(usteps);
});
...
$(document).on("click", '.uengager_editor_background', function(){
	if(show_background){
		show_background = false;
		show_background_o = false;
		$(this).removeClass("uengager_editor_button_blue");
		$(this).addClass("uengager_editor_button_gray");
		$(this).html("背景隐藏");
	}else{
		show_background = true;
		show_background_o = 0.8;
		$(this).removeClass("uengager_editor_button_gray");
		$(this).addClass("uengager_editor_button_blue");
		$(this).html("背景显示");
	}
	
})

function startEditonew() {
  var editor = introJs();
	try{
		editor.setOptions({
			hidePrev: true,
			...
			doneLabel: 'OK',
			steps: [{
				element: document.querySelector('#uengager_editor > div:nth-child(1) > div:nth-child(1)'),
				intro: '点击开始操作',
				position: 'auto'
				}]
		});
